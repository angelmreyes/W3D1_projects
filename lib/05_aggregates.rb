...
def populous_continents
  ...
  SQL
end #Used instead of WHERE with aggregate functions. If you will use GROUP BY or
#aggregate functions, you must use HAVING instead of WHERE to check conditionals.